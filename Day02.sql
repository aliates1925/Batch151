...
--SORU3: kursiyerler tablosundaki isim'i 'Derya Soylu' veya 'Yavuz Bal' olan verileri siliniz.
...
update film set film_ismi='Babam ve Oglum', film_turu='Dram' where film_no=700;
